        ...
        <div className="row">
          ...
          <div className="col-lg-9">
            <div id='containerTop' className='text-light bg-dark'>
              <img id='coverPic' src="https://www.photofunny.net/i/4285_customizable-cover-photo-for-facebook-with-cat-with-sunglass.jpg" />

              <img id='profilePic' src="https://scontent.fcjb6-1.fna.fbcdn.net/v/t1.6435-9/135803447_1913100415526329_8197056743435403936_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=hixBoRwA3ZMAX_5NJ0G&_nc_ht=scontent.fcjb6-1.fna&oh=00_AfCKypWdYxqTqGjyiVYQtrWfqP461ys1UefTRQQZjQh9Aw&oe=64F0675A" alt="" />
              <div id='idName' >
                <div id='idLeft'>
                  <p className='fs-3'>Jaba raj</p>
                  <p>213 friends</p>
                </div>
                <div id='AddStoryBtn'>
                ...
                <div id='EditProfileBtn'>
                  <button className='btn btn-secondary mx-4'>Edit Profile</button>
                </div>
              </div>
            </div>
            {/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/}
